...
<html>
	<head>
		<title>Team Fast Agents | Listing</title>
	...
	<body>
				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 6558 Simson St? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="portfolio" class="two">
						<div class="container">
							...
							<div class="row">
								<div class="4u">
									<article class="item">
										<a href="images/simson.jpg" class="image full fancybox"><img src="images/simson.jpg" alt="" /></a>
										<header>
								...
								<div class="4u">
									<article class="item">
										<a href="images/simson.jpg" class="image full fancybox"><img src="images/cam2.jpg" alt="" /></a>
										<header>
											<h3>Professional Photography</h3>
										</header>
									</article>
									<article class="item">
										<a href="images/printad2.jpg" class="image full fancybox"><img src="images/printad2.jpg" alt="" /></a>
										<header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 6558 Simson St</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
		...
		<!-- Footer -->
			<div id="footer" style="background-color: #2c3e50; color: #000;">
